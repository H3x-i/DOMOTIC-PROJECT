...
void lq_printInt(struct LiquidCrystalDevice_t* device, int value){
	uint8_t stringSize = log10f(value)+1;
	char number[stringSize+1];
	lq_print(device, itoa(value, number, 10));
}
